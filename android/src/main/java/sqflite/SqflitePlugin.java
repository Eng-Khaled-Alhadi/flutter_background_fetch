...
import static sqflite.Constant.CMD_GET;
import static sqflite.Constant.ERROR_BAD_PARAM;
import static sqflite.Constant.MEMORY_DATABASE_PATH;
import static sqflite.Constant.METHOD_BATCH;
import static sqflite.Constant.METHOD_CLOSE_DATABASE;
import static sqflite.Constant.METHOD_DEBUG;
import static sqflite.Constant.METHOD_DEBUG_MODE;
import static sqflite.Constant.METHOD_DELETE_DATABASE;
import static sqflite.Constant.METHOD_EXECUTE;
import static sqflite.Constant.METHOD_GET_DATABASES_PATH;
import static sqflite.Constant.METHOD_GET_PLATFORM_VERSION;
import static sqflite.Constant.METHOD_INSERT;
import static sqflite.Constant.METHOD_OPEN_DATABASE;
import static sqflite.Constant.METHOD_OPTIONS;
import static sqflite.Constant.METHOD_QUERY;
import static sqflite.Constant.METHOD_UPDATE;
import static sqflite.Constant.PARAM_CMD;
import static sqflite.Constant.PARAM_ID;
import static sqflite.Constant.PARAM_IN_TRANSACTION;
import static sqflite.Constant.PARAM_LOG_LEVEL;
import static sqflite.Constant.PARAM_OPERATIONS;
import static sqflite.Constant.PARAM_PATH;
import static sqflite.Constant.PARAM_READ_ONLY;
import static sqflite.Constant.PARAM_RECOVERED;
import static sqflite.Constant.PARAM_RECOVERED_IN_TRANSACTION;
import static sqflite.Constant.PARAM_SINGLE_INSTANCE;
import static sqflite.Constant.PARAM_SQL;
import static sqflite.Constant.PARAM_SQL_ARGUMENTS;
import static sqflite.Constant.TAG;
...
import sqflite.dev.Debug;
import sqflite.operation.BatchOperation;
import sqflite.operation.ExecuteOperation;
import sqflite.operation.MethodCallOperation;
import sqflite.operation.Operation;
import sqflite.operation.SqlErrorInfo;
